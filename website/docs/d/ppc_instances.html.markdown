...
layout: "ibm"
page_title: "IBM: ppc_instances"
description: |-
  List all the Power instances for the respective cloud instance in the Power Private Cloud.
---

# ibm_ppc_instances
Retrieve information about all Power Private Cloud instances for the given cloud instance. For more information, about Power instances, see [getting started with IBM Power Private Cloud](https://cloud.ibm.com/docs/power-iaas?topic=power-iaas-getting-started).

## Example usage

```terraform
data "ibm_ppc_instances" "ds_instance" {
...
- `pvm_instances` - List of Power instances for respective cloud instance.
