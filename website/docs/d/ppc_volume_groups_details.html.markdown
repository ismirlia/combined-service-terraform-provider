...
layout: "ibm"
page_title: "IBM: ppc_volume_groups_details"
description: |-
  Manages a volume groups in the Power Private Cloud.
---

# ibm_ppc_volume_groups_details
...
## Example usage
The following example retrieves information about the volume groups with details that is present in Power Private Cloud.
```terraform
data "ibm_ppc_volume_groups_details" "ds_volume_groups_details" {
