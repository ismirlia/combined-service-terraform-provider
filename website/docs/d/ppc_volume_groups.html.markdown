...
layout: "ibm"
page_title: "IBM: ppc_volume_groups"
description: |-
  Manages a volume groups in the Power Private Cloud.
---

# ibm_ppc_volume_groups
...
## Example usage
The following example retrieves information about all volume groups present in Power Private Cloud.
```terraform
data "ibm_ppc_volume_groups" "ds_volume_groups" {
