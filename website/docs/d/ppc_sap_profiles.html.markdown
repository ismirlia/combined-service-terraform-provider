...
layout: "ibm"
page_title: "IBM: ppc_sap_profiles"
description: |-
  Manages SAP profiles in the Power Private Cloud.
---

# ibm_ppc_sap_profiles
Retrieve information about all SAP profiles. For more information, see [getting started with IBM Power Private Cloud](https://cloud.ibm.com/docs/power-iaas?topic=power-iaas-getting-started).

## Example usage

```terraform
data "ibm_ppc_sap_profiles" "example" {
